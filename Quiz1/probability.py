...
for i in range(num_instances):
    ...
    question_text = fr"Consider the quantum state {a}\(|0\rangle\) + {b}\(|1\rangle\). On measuring this state in the computational basis, what is the probability that the state collapses to \(|0\rangle\)?"
